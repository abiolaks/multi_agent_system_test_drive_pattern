/**
 * Proxy for POST /api/mail/confirm — approves and sends a drafted email
 * (the ADR 0009 human-in-the-loop gate: drafting is automatic, sending
 * never is).
 */
...
export async function POST(request: NextRequest) {
  ...
  return proxyJson(`${BACKEND}/api/mail/confirm`, {
    method: "POST",
